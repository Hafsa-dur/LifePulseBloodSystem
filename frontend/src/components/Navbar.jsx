...
const Navbar = () => {
  return (
    <nav className="bg-[#5A1827] border-b-2 border-[#E5C158]/30 py-4 px-6 md:px-12 flex justify-between items-center text-white font-sans shadow-md sticky top-0 z-50">
      ...
      {/* Navigation Links */}
      <div className="hidden md:flex items-center gap-6 text-xs font-black uppercase tracking-wider text-rose-100">
