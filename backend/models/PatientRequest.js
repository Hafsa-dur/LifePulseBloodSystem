...
const patientRequestSchema = new mongoose.Schema({
  ...
  donorLocation: { type: String, trim: true, default: '' },
  donorDistance: { type: Number, default: null },
  ...
  locationMatchStatus: { type: String, enum: ['Pending', 'Matched', 'No Donor', 'Failed'], default: 'Pending' },
